...
class _ListaPedidosVendedorPageState extends State<ListaPedidosVendedorPage> {
  ...
  void _filterPedidos(String query) {
    setState(() {
      _filteredPedidos = _allPedidos.where((p) {
        ...
        final clienteFullName = "${p.cliente?.nombreCliente} ${p.cliente?.apellidoCliente}".toLowerCase();
        return p.idPedido.toString().contains(searchLower) || clienteFullName.contains(searchLower);
      }).toList();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            const AppPageHeader(title: "Mis entregas", subtitle: "Pedidos asignados"),
            _buildSearchBar(),
            Expanded(
              child: _isLoading
                ...
                : _filteredPedidos.isEmpty
                  ...
                  : RefreshIndicator(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => _PedidoCardVendedor(pedido: _filteredPedidos[index]),
                      ),
                    ),
            ),
          ],
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(Icons.search, color: AppTheme.accentOlive),
          filled: true,
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Text(
        _searchController.text.isEmpty ? "NO TIENES PEDIDOS\nASIGNADOS" : "SIN RESULTADOS PARA\nLA BÚSQUEDA",
...
// ... El Widget _PedidoCardVendedor se mantiene igual, ya que recibe el modelo filtrado.
      ...
      child: Column(
        children: [
          ListTile(
            ...
            trailing: Icon(_isExpanded ? Icons.keyboard_arrow_up_rounded : Icons.keyboard_arrow_down_rounded, color: AppTheme.textSecondary),
          ),
          if (_isExpanded)
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...p.detalles.map((d) => Padding(padding: const EdgeInsets.only(bottom: 4), child: Text("• ${d.cantidad}x ${d.nombre}", style: AppTheme.bodySmall))),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(side: BorderSide(color: AppTheme.borderFocus), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 12),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(label, style: AppTheme.caption), Text(value, style: AppTheme.bodySmall)]))
        ],
      ),
    );
  }
