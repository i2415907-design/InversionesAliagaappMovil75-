    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              const AppPageHeader(title: "Mi perfil", subtitle: "Actualiza tu contraseña y datos"),
              Container(
                width: double.infinity,
                padding: const EdgeInsets.all(22),
                decoration: AppTheme.cardDecoration(radius: AppTheme.radiusCard),
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color.fromARGB(255, 99, 143, 110),
  ...
  Widget _modernProfileInput(String hint, {bool isPassword = false, bool isReadOnly = false, TextEditingController? controller}) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AppTheme.radiusInput), borderSide: BorderSide.none),
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AppTheme.radiusInput), borderSide: BorderSide(color: AppTheme.borderFocus)),
      ),
    );
  }
}